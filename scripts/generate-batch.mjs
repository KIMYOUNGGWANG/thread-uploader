...
예시: "도화살 = 바람기? (X) → 연예인급 인기 (O)", "이직운 대박 = 지금 퇴사? (X) → 리스크 헷징 후 이동 (O)"`
  },
  {
    id: "choice",
    name: "편가르기",
...
const TRENDING_HASHTAGS = ["이직고민", "진로고민", "사주", "진태양시", "자미두수", "의사결정", "심리", "동기부여", "라이프스타일", "인간관계", "자기계발", "사주팔자", "연애운", "재물운", "직업운", "새벽감성", "공감", "현실공감", "멘탈관리", "감정정리", "오늘의운세"];

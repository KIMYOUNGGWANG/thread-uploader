# 🏭 Orchestrator 6.1 — Antigravity Mission Control (GEMINI.md)

> **"로컬 환경(Antigravity IDE) 전용 운영 허브 및 워크플로우 엔진."**
> **Version 6.1** — Single Source of Truth.
> 
...
## 🏗️ 2. Architecture & Pipeline (v6.1)
...
| P3 | Database Schema | `/plan`, `/mvp` | 스키마 셋업 (client project 기준) |
...
## 🛠️ 7. Embedded Engineering Standards (v6.1)
